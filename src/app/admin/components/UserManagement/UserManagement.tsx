...
import { CreateMasterCont, LoadingWrapper, SubmitButton, TitlesAdmin, UserCont } from '../StyledComponents';
import useAddMaster from './hooks/useAddMaster';
import useUsersSearch from './hooks/useUsersSearch';
import { use, useEffect } from 'react';
import Link from 'next/link';
import { StyledLink } from '@/app/components/Links/LinksStyles';
  ...
  return (
    <>
      <TitlesAdmin>
        ...
        <StyledLink href={"/admin"}>Управление заявками</StyledLink>
      </TitlesAdmin>
